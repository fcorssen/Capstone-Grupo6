...
for cor in coordinate_driver:
    if c < 10:
        folium.CircleMarker([cor[0], cor[1]], color='green', radius=8).add_to(m)
    if c > 10:
        folium.CircleMarker([cor[0], cor[1]], color='red', radius=8).add_to(m)
    c += 1
...
for cor in coordinate_center:
        ...
        folium.CircleMarker([cor[0], cor[1]], color='blue', radius=10).add_to(m)
...
for cor in coordinate_eccomerce:
        ...
        folium.CircleMarker([cor[0], cor[1]], color='black', radius=4).add_to(m)
